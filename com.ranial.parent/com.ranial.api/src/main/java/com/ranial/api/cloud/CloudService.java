 ...
 * It operates as a decorator for the {@link com.ranial.api.data.DataService} providing add-on
...
{    
    ...
    /**
     * Returns true if the underlying {@link com.ranial.api.data.DataService} is currently connected to the remote server. 
     * @return
     */
